...
public class Point3D{
	...
	public static Matrix projectionMatrix() {
		...
		if (projector == null) { 
			double width = Graphy3Driver.getWidth();
			double height = Graphy3Driver.getHeight();
			double fov = Graphy3Driver.fov;
			double zFar = Graphy3Driver.zFar;
			double zNear = Graphy3Driver.zNear;
	...
	public static Point3D project(Point3D point) {
		...
		point.setX((point.x + 0.5 )* Graphy3Driver.getWidth());
		point.setY((point.y + 0.5 ) * Graphy3Driver.getHeight());
		return point;
	}
